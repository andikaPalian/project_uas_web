...
<main class="container-fluid">
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white">
            <h5 class="card-title m-0 fw-bold">Edit Produk: <?= htmlspecialchars($produk['nama']) ?></h5>
        </div>
        <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <?php if ($produk['gambar']): ?>
                                <small class="form-text text-muted mt-2 d-block">
                                    Gambar saat ini: <a href="uploads/produk/<?= $produk['gambar'] ?>" target="_blank"><?= $produk['gambar'] ?></a>
                                </small>
                            <?php endif; ?>
                        </div>
                    </div>
